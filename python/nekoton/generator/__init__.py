...
'''
    ...
    def generate_abi_class(self, name: str, abi: str) -> str:
        ...
        class_name = f"{pascalize(name)}Abi"
        ...
        result = ClassBuilder(class_name)
...
"""
    ...
    def generate_function(self, base_class: str, function: dict) -> InternalFunction:
        ...
        function_class = base_class + pascalize(name) + "Function"
        ...
        method = MethodBuilder("with_args", {
            "self": None,
            "args": inputs_ty,
        }, function_with_args_ty).with_body(f"return {function_abi_ty}.with_args(self, args)")

        result = ClassBuilder(function_class).with_base(function_abi_ty).with_method(method).generate()
        return InternalFunction(name, inputs_ty, outputs_ty, InternalStruct(function_class, result))
